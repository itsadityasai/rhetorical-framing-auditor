...
#### `docs/inlp_proposal.pdf`
Project proposal. Covers background, related work, the full 4-step pipeline (data collection → RST parsing → fact alignment → prominence scoring), and evaluation plan (label alignment accuracy + ablation study on nuclearity weighting).

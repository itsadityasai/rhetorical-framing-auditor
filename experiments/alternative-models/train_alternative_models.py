...
DEFAULT_OUT_PATH = "experiments/alternative-models/results/alternative_models_results.json"
DEFAULT_MODEL_DIR = "experiments/alternative-models/results/models"

...
DEFAULT_OUT_PATH = "experiments/ordering-str/by-cluster-size/results/ordered_dfi_results.json"
DEFAULT_MODEL_DIR = "experiments/ordering-str/by-cluster-size/results/models"

...
DEFAULT_OUT_PATH = (
    "experiments/universal-str/structural-stats/results/structural_stats_results.json"
)
DEFAULT_MODEL_DIR = "experiments/universal-str/structural-stats/results/models"

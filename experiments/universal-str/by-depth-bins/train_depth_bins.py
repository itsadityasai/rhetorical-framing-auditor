...
DEFAULT_OUT_PATH = "experiments/universal-str/by-depth-bins/results/depth_bins_results.json"
DEFAULT_MODEL_DIR = "experiments/universal-str/by-depth-bins/results/models"

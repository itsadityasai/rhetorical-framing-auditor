...
DEFAULT_OUT_PATH = (
    "archive/ordering-str/by-coverage-asymmetry/results/ordered_dfi_results.json"
)
DEFAULT_MODEL_DIR = "archive/ordering-str/by-coverage-asymmetry/results/models"

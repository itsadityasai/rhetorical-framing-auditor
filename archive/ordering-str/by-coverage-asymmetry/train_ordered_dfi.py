...
DEFAULT_OUT_PATH = "ordering-str/by-coverage-asymmetry/results/ordered_dfi_results.json"
DEFAULT_MODEL_DIR = "ordering-str/by-coverage-asymmetry/results/models"

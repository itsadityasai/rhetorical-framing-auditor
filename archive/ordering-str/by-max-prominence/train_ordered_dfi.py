...
DEFAULT_OUT_PATH = "archive/ordering-str/by-max-prominence/results/ordered_dfi_results.json"
DEFAULT_MODEL_DIR = "archive/ordering-str/by-max-prominence/results/models"

...
DEFAULT_OUT_PATH = (
    "archive/universal-str/disparity-signature/results/disparity_signature_results.json"
)
DEFAULT_MODEL_DIR = "archive/universal-str/disparity-signature/results/models"
